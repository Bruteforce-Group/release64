...
public:
    ...
    void setupUi(QMainWindow *ConsoleWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/application-exit.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        ConsoleWindow->addToolBar(Qt::ToolBarArea::TopToolBarArea, mainToolBar);
