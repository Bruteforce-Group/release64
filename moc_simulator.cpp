...
#include "../fritzing-app/src/simulation/simulator.h"
...
template <> constexpr inline auto Simulator::qt_create_metaobjectdata<qt_meta_tag_ZN9SimulatorE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "Simulator",
        "simulationStartedOrStopped",
        "",
        "running",
        "simulationEnabled",
        "enabled",
        "enable",
        "enableTransientSimulation",
        "stopSimulation",
        "startSimulation",
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'simulationStartedOrStopped'
        QtMocHelpers::SignalData<void(bool)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 3 },
        }}),
        // Signal 'simulationEnabled'
        ...
        // Slot 'enableTransientSimulation'
...
void Simulator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->simulationStartedOrStopped((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->simulationEnabled((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 2: _t->enable((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 3: _t->enableTransientSimulation((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 4: _t->stopSimulation(); break;
        case 5: _t->startSimulation(); break;
        case 6: _t->showSimulationResults(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Simulator::*)(bool )>(_a, &Simulator::simulationStartedOrStopped, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Simulator::*)(bool )>(_a, &Simulator::simulationEnabled, 1))
            return;
    }
}
...
// SIGNAL 0
void Simulator::simulationStartedOrStopped(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Simulator::simulationEnabled(bool _t1)
{
