...
#include "../fritzing-app/src/sketch/zoomablegraphicsview.h"
...
void ZoomableGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->zoomOutOfRange((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ZoomableGraphicsView::*)(double )>(_a, &ZoomableGraphicsView::zoomChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ZoomableGraphicsView::*)(double )>(_a, &ZoomableGraphicsView::zoomOutOfRange, 1))
            return;
    }
}
