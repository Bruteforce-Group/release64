...
namespace {
struct qt_meta_tag_ZN24AutorouterSettingsDialogE_t {};
} // unnamed namespace

template <> constexpr inline auto AutorouterSettingsDialog::qt_create_metaobjectdata<qt_meta_tag_ZN24AutorouterSettingsDialogE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AutorouterSettingsDialog, qt_meta_tag_ZN24AutorouterSettingsDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AutorouterSettingsDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN24AutorouterSettingsDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN24AutorouterSettingsDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN24AutorouterSettingsDialogE_t>.metaTypes,
    nullptr
} };
...
void *AutorouterSettingsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN24AutorouterSettingsDialogE_t>.strings))
