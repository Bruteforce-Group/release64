...
#include "../fritzing-app/src/program/consolewindow.h"
...
namespace {
struct qt_meta_tag_ZN13ConsoleWindowE_t {};
} // unnamed namespace

template <> constexpr inline auto ConsoleWindow::qt_create_metaobjectdata<qt_meta_tag_ZN13ConsoleWindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ConsoleWindow, qt_meta_tag_ZN13ConsoleWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ConsoleWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13ConsoleWindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13ConsoleWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13ConsoleWindowE_t>.metaTypes,
    nullptr
} };
...
void *ConsoleWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13ConsoleWindowE_t>.strings))
