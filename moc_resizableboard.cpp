...
#include "../fritzing-app/src/items/resizableboard.h"
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->fileNameEntry((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
...
namespace {
struct qt_meta_tag_ZN14ResizableBoardE_t {};
} // unnamed namespace

template <> constexpr inline auto ResizableBoard::qt_create_metaobjectdata<qt_meta_tag_ZN14ResizableBoardE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "ResizableBoard",
    ...
    return QtMocHelpers::metaObjectData<ResizableBoard, qt_meta_tag_ZN14ResizableBoardE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ResizableBoard::staticMetaObject = { {
    QMetaObject::SuperData::link<Board::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14ResizableBoardE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14ResizableBoardE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14ResizableBoardE_t>.metaTypes,
    nullptr
} };

void ResizableBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<ResizableBoard *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->widthEntry(); break;
        case 1: _t->heightEntry(); break;
        case 2: _t->keepAspectRatio((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 3: _t->revertSize((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 4: _t->paperSizeChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14ResizableBoardE_t>.strings))
        return static_cast<void*>(this);
